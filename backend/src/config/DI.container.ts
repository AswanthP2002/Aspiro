...
import { AdminBlockUserUsecase } from '../application/usecases/user/AdminBlockUser.usecase';
...
import ILoadUsersAdminUseCase from '../application/interfaces/usecases/user/ILoadUsersAdmin.usecase';
import { LoadMyProfileUsecase } from '../application/usecases/user/LoadMyProfileUsecase.usecase';
...
import AddUserExperienceUsecase from '../application/usecases/experience/AddUserExperience.usecase';
import IGetUserExperiencesUsecase from '../application/interfaces/usecases/experience/IGetUserExperiences.usecase';
import GetUserExperiencesUsecase from '../application/usecases/experience/GetUserExperience.usecase';
...
import AddUserEducationUsecase from '../application/usecases/education/AddUserEducation.usecase';
import IGetUserEducationsUsecase from '../application/interfaces/usecases/education/IGetUserEducations.usecase';
import GetUserEducationsUsecase from '../application/usecases/education/GetUserEducations.usecase';
...
import AddUsersSkillsUsecase from '../application/usecases/skill.user/AddUserSkills.usecase';
import IGetUserSkillsUsecase from '../application/interfaces/usecases/skill.user/IGetUserSkills.usecase';
import GetUserSkillsUsecase from '../application/usecases/skill.user/GetUserSkills.usecase';
import IEditUserEducationUsecase from '../application/interfaces/usecases/education/IEditUserEducation.usecase';
import EditUserEducationUsecase from '../application/usecases/education/EditUserEducation.usecase';
import IEditUserExperienceUsecase from '../application/interfaces/usecases/experience/IEditUserExperience.usecase';
import EditUserExperienceUsecase from '../application/usecases/experience/EditUserExperience.usecase';
import IDeleteUserEducationUsecase from '../application/interfaces/usecases/education/IDeleteUserEducation.usecase';
import DeleteUserEducationUsecase from '../application/usecases/education/DeleteUserEducation.usecase';
...
import DeleteUserSkillUsecase from '../application/usecases/skill.user/DeleteUserSkill.usecase';
...
import ILoadJobsAggregatedUsecase from '../application/interfaces/usecases/job/IloadJobsAggregated.usecase';
import LoadJobsAggregatedUsecase from '../application/usecases/job/LoadJobsAggregated.usecase';
...
import IAdminBlockUserUsecase from '../application/interfaces/usecases/user/IAdminBlockUser.usecase';
import IAdminUnblockUserUsecase from '../application/interfaces/usecases/user/IAdminUnblockUser.usecase';
...
import ApproveRecruiterApplicationUsecase from '../application/usecases/recruiter/ApproveRecruiterApplication.usecase';
import IGetJobDetailsUseCase from '../application/usecases/interfaces/IGetJobDetails.usecase';
import GetJobDetailsUseCase from '../application/usecases/job/GetJobDetails.usecase';
...
import IApplyJobUsecase from '../application/interfaces/usecases/jobApplication/IApplyJob.usecase';
...
import AddResumeUseCase from '../application/usecases/resume/AddResume.usecase';
import IGetMyApplicationsUsecase from '../application/interfaces/usecases/jobApplication/IGetMyApplications.usecase';
...
import AddCertificateUseCase from '../application/usecases/certificate/AddCertificate.usecase';
import ILoadCertificateUseCase from '../application/interfaces/usecases/certificate/IGetCeritificates.usecase';
import GetCertificatesUseCase from '../application/usecases/certificate/GetCertificates.usecase';
...
import IUnblockRecruiterUsecase from '../application/usecases/admin/interfaces/IUnblockCompany.usecase';
...
import DeleteRecruiterUsecaase from '../application/usecases/company/CloseCompany.usecase';
...
import ILoadMyProfileUsecase from '../application/interfaces/usecases/user/ILoadMyProfile.usecase';
...
import ILoadUserPublicProfileUsecase from '../application/interfaces/usecases/user/ILoadUserAggregatedProfile.usecase';
import LoadUserpublicProfileUsecase from '../application/usecases/user/LoadUserAggregatedProfile.usecase';
...
import LoadUserMetaDataUsecase from '../application/usecases/user/LoadUserMetaData.usecase';
...
import { ConnectionManager } from '../infrastructure/socketio/connectionManager';
import ISendAttachmentUsecase from '../application/interfaces/usecases/chat/ISendAttachment.usecase';
import SendAttachmentUsecase from '../application/usecases/chat/SendAttachment.usecase';
...
container.registerSingleton<ISendAttachmentUsecase>(
  'ISendAttachmentUsecase',
...
container.registerSingleton(ConnectionManager); //connection manager dependancy created
