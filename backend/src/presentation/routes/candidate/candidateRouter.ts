...
function createCandidateRouter() {
  ...
  const saveCandidateBasicUC = new SaveIntroDetailsUseCase(
    candidateRepo,
    userRepo
  );
  const loadCandidatePersonalDataUC = new LoadCandidatePersonalDataUC(
    candidateRepo
  );
  ...
  const uploadProfilePictureUC = new UploadProfilePictureUseCase(
    candidateRepo,
    userRepo
  );
  const removeProfilePictureUC = new RemoveProfilePictureUseCase(
    candidateRepo,
    userRepo
  );
  const uploadCoverPhotoUC = new UploadCoverphotoUseCase(
    candidateRepo,
    userRepo
  );
  const removeCoverPhotoUC = new RemoveCoverphotoUseCase(
    candidateRepo,
    userRepo
  );
  ...
  const getCandidateApplicationsUC = new GetCandidateApplicationsUseCase(
    jobApplicationRepo
  );
  const updateNotificationReadStatus = new UpdateNotificationReadStatus(
    notificationRepo
  );
  ...
  //   console.log('request body in the router', req.body);
