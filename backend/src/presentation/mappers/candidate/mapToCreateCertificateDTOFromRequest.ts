import { CreateCertificateDTO } from "../../../application/DTOs/candidate/certificateDTO";
import { AddCertificateRequestDTO } from "../../DTOs/candidate/addCertificateRequestDTO";

export default function mapToCreateCertificateDTOFromRequest(requestDto : AddCertificateRequestDTO) : CreateCertificateDTO {
    return {
