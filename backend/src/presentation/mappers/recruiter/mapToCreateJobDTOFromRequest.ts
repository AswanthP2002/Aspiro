import CreateJobDTO from "../../../application/DTOs/recruiter/createJobDTO";
import CreateJobRequestDTO from "../../DTOs/recruiter/createJobRequestDTO";

export default function mapToCreateJobDTOFromRequest(requestDTO : CreateJobRequestDTO) : CreateJobDTO {
    return {
