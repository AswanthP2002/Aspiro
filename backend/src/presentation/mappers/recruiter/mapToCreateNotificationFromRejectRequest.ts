import CreateNotificationDTO from '../../../application/DTOs/notifications.dto';
import RejectJobApplicationRequestDTO from '../../DTOs/recruiter/rejectJobApplicationRequestDTO';

export default function mapToCreateNotificationFromRejectRequest(
  requestDto: RejectJobApplicationRequestDTO
