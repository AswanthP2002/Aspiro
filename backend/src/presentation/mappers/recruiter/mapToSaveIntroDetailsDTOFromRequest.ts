import SaveIntroDetailsDTO from "../../../application/DTOs/recruiter/saveIntroDetailsDTO";
import SaveIntroDetailsRequestDTO from "../../DTOs/recruiter/saveIntroDetailsRequestDTO";

export default function mapToSaveIntroDetailsDTOFromRequest(requestDto : SaveIntroDetailsRequestDTO) : SaveIntroDetailsDTO {
    return {
        id:requestDto.id,
