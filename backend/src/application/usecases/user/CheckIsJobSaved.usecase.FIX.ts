...
import ICheckIsJobSavedUseCase from '../../interfaces/usecases/user/ICheckIsJobSaved.usecase.FIX';

@injectable()
export default class CheckIsJobSavedUseCase implements ICheckIsJobSavedUseCase {
  constructor(@inject('IFavoriteJobRepository') private _favoritejobRepo: IFavoriteJobsRepo) {}
