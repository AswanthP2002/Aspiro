...
import IGetFinalizedShortlistData from "./interface/IGetFinalizedDataUseCase";

export default class GetFinalizedDataUseCase implements IGetFinalizedShortlistData {
