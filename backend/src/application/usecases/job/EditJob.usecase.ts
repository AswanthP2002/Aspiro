...
import IEditJobUsecase from '../../interfaces/usecases/job/IEditJob.usecase';
import IJobRepo from '../../../domain/interfaces/IJobRepo';
import { EditJobDTO, JobDTO } from '../../DTOs/job/createJob.dto';
import mapToJobFromEditJobDTO from '../../mappers/job/mapToJobFromEditJobDTO.mapper';
import mapToJobDTOFromJob from '../../mappers/job/mapToJobDTOFromJob.mapper';
