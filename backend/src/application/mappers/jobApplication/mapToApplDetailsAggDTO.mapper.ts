import ApplicationDetailsAggregated from '../../../domain/entities/jobApplication/jobApplicationDetailsAggregated.entity';
import ApplicationDetailsAggregatedDTO from '../../DTOs/jobApplication/applicationDetailsAgg.dto';
