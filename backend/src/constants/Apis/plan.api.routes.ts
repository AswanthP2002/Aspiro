export const PlanApiRoutes = {
  ADMIN: {
    ...
    DELETE_PLAN_BY_ID: '/v2/subscription/plans/:planId/delete',
  ...
  USER: {
    ...
    SUBSCRIBE_FREE_PLAN: '/v2/plans/subscribe/free/:planId',
    SUBSCRIBE_PAID_PLAN: '/v2/plans/subscribe/paid/:planId',
    GET_SESSION_DETAILS: '/v2/plans/subscription/session/:sessionId',
