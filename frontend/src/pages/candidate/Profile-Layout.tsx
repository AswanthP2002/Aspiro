    ...
    return(
        ...
        <aside className="w-[350px] bg-gray-50 min-h-screen border-r border-gray-300 pl-20">
          <ul className="space-y-2 py-4">
            <li className="mt-6 text-sm"><Link to={'/candidate/profile/personal'}><i className="fa-solid fa-boxes-stacked me-2"></i>Overview</Link></li>
            ...
            <li className="mt-6 text-sm"><Link to={'/candidate/profile/experience'}><i className="fa-solid fa-brain me-2"></i>Skills & Experience</Link></li>
