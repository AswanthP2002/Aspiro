...
//     function searchCandiates(event : React.ChangeEvent<HTMLInputElement>){
//         setSearch(event?.target?.value)
//     }

//     function debouncedSearch <T extends (...args: never[]) => void>(fun : T, delay : number){
...
//         }
//     }
//     //stoped here, cleaning any from the fronted
