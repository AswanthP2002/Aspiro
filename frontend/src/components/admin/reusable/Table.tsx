        ...
        <thead>
          <tr>
            {columns.map((col, index) => (
              <th
                className="px-6  py-4 whitespace-nowrap text-xs font-semibold tracking-wider text-gray-500 uppercase"
          ...
          {data.map((row, index) => (
            <tr className="hover:bg-gray-50 transition-colors" key={index}>
              {columns.map((col, colIndex) => (
                <td
                  className="px-6 whitespace-nowrap py-4 text-sm text-gray-700 whitespace-nowrap"
