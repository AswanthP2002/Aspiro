...
//             <ApplicantCardOptions reject={rejectMethod} removeFromShortlist={removeFromShortlist} flag={flag} showCard={showOptions} selectMethod={selectMethod} addToShortListMethod={addToShortlistMethod} rejectMethod={rejectMethod} />
